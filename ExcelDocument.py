...
class ExcelDocument(object):
    ...
    def get_range(self, t_range):
        """
        Get a range object for the specified range or single cell.
        """
        return self.app.ActiveWorkbook.Sheets(self.sheet).Range(t_range)
    ...
    def set_border(self, t_range, side, line_style=borderSolid, color=colorBlack):
        """
        ...
        """
        t_range = self.get_range(t_range).Borders(side)
        t_range.LineStyle = line_style
        t_range.Color = color

    def sort(self, t_range, key_cell):
        """
